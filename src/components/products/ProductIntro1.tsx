...
export interface ProductIntro1Props {
  imgUrl?: string[]
  title: string
  price: number
  id?: string | number
...
const ProductIntro1: React.FC<ProductIntro1Props> = ({
  imgUrl = [],
  title,
  price = 200,
  id,
      ...
      <Grid container spacing={3} justifyContent="space-around">
        ...
        <Grid item md={6} xs={12} alignItems="center">
          ...
          <FlexBox alignItems="center" mb={2}>
            <Box>Location:</Box>
            <H6 ml={1}>University of Maryland</H6>
          </FlexBox>
...
ProductIntro1.defaultProps = {
  imgUrl: [
    '/assets/images/products/sony_1.jpg',
    '/assets/images/products/sony2.jpg',
    '/assets/images/products/sony3.jpg',
  ],
  title: 'Sony Camera a7iii Set',
  price: 50,
}
